  ...
  return (
    <div
      className={cn(
        ...
        recommended &&
          "py-[70px] dark:bg-violet-700 dark:text-gray-100 bg-violet-700 text-violet-50 lg:mt-0 z-10 lg:-mx-2.5 shadow-[0px_4px_44px_0px_#A78BFA] dark:shadow-[0px_4px_44px_0px_#020617]"
      )}
    >
      <h3
        className={cn(
                ...
                >
                  <path
                    ...
                    className={cn(
                      ...
                      recommended && "dark:fill-violet-200 fill-violet-50"
                    )}
                  />
                </svg>
              )}
